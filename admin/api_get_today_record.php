...
$base_url = (strpos($_SERVER['HTTP_HOST'], 'localhost') !== false) ? "http://localhost/worklog/member/uploads/" : "http://172.16.124.115/worklog/member/uploads/"; //ต้องเปลี่ยนเวลาที่ขึ้น server จริง
